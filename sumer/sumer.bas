...
280 REM  MAIN LOOP
285 REM --------------------------------------------------
290 FOR A0 = 3502 TO 3501 STEP -1
...
510 DATA "SUMER. YOU HAVE TWELVE YEARS TO RUN YOUR EMPIRE."
515 DATA "\X11"
...
575 DATA "WINNING A WAR WILL INCREASE LOYALTY.  DO NOT START A WAR IF THE "
...
610 REM --------------------------------------------------
615 ? CL$(4);
620 ? SP$ "O HAMMURABI, I AM SORRY TO REPORT, ";
625 ? "IN YEAR" (3513 - A0);
630 ? "(" A0 "BC )"
635 ? HR$ "\X11"
640 RETURN
...
1275 B7 = B7 + B6 * A6
1280 REM BIRTHS
1285 B1 = INT( (A9-0.5) * A8 * RND(1)/8 )
1290 A8 = A8 + B1
1295 REM IMMIGRATION
1300 B4 = INT( (B0-0.5) * A8 * RND(1)/5 )
1305 A8 = A8 + B4
1310 REM START/END PLAGUE
1315 A1 = 0
1320 IF RND(1)>0.7 THEN A1 = INT(A8 * RND(1) * 0.5) 
1325 IF A1>0 THEN A9 = A9 * 0.9 :REM ERODE HEALTH
1330 A8 = A8 - A1
1335 REM START/END FAMINE
1340 IF RND(1)>0.7 THEN A2 = INT(RND(1)*4+1) 
1345 IF RND(1)<0.2 THEN A2 = 0
1350 REM WAGE WAR
1355 IF A3 = 0 GOTO 1360
1360 RETURN
